...
CLASS lcl_handler IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity        TYPE STRUCTURE FOR CREATE ZRAP100_i_Travel_MS,
...
"test
    READ ENTITIES OF ZRAP100_i_Travel_MS IN LOCAL MODE
   ENTITY Travel
   ...
   FAILED DATA(read_failed).
    ...
    MODIFY ENTITIES OF ZRAP100_i_Travel_MS IN LOCAL MODE
      ENTITY Travel
        UPDATE SET FIELDS
...
**************************************************************************
 METHOD deductDiscount.
   DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_i_Travel_MS.
...
**************************************************************************
 METHOD copyTravel.
    DATA:
      travels       TYPE TABLE FOR CREATE zrap100_i_travel_MS\\travel.
