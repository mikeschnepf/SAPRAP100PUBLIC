CLASS zcl_rap100_gen_data_ms DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_ms IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.

    DATA table_name TYPE string VALUE 'zrap100_atravms'.
*    DATA draft_table_name TYPE string VALUE 'zrap100_dtravms'.
